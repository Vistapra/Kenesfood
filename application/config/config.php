...
$config['private'] = '20';
$config['member'] = '11';
$config['member_role'] = '1100';

$config['display_errors'] = TRUE;

// action
$config['action'] = array('detail', 'add', 'edit', 'delete', 'add_variant', 'delete_varian', 'edit_variant', 'add_sub_cat', 'delete_sub_cat', 'edit_sub_cat', 'download', 'edit_app_role', 'list_menu_all', 'delete_menu', 'whatsapp', 'getData');
$config['allowance'] = [
	'detail' => 'read',
	'add' => 'create',
	'edit' => 'edit',
...
/*
|--------------------------------------------------------------------------
| MRP API Configuration
|--------------------------------------------------------------------------
|
| API Key untuk autentikasi endpoint update produk dari MRP
|
*/
$config['mrp_api_key'] = '0a6a2c9d1b10d26ef70f773c68c0f58e5eb85a6624015f12d70c635a23376c1f'; // Gunakan key yang aman dan kompleks dalam produksi