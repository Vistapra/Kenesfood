...
class Data extends ApplicationBase
{
	...
	public function dashboard()
	{
		...
		// get recent orders (5 orders terbaru)
		$recent_orders = $this->dashboard->get_recent_orders(5);
		$this->tsmarty->assign('recent_orders', $recent_orders);

		// get active promos (5 promo aktif)
		$active_promos = $this->dashboard->get_active_promos(5);
		$this->tsmarty->assign('active_promos', $active_promos);

		// get notifications (5 notifikasi terbaru)
		$notifications = $this->dashboard->get_notifications(5);
		$this->tsmarty->assign('notifications', $notifications);

		// get product summary stats
		$product_summary = $this->dashboard->get_product_summary();
		$this->tsmarty->assign('product_summary', $product_summary);
